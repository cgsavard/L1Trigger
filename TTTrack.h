...
private:
  ...
  double theTrkMVA2_;
  double theTrkMVA3_;
  std::vector<double> theTrkMVAvector_;
...
public:
  ...
  std::vector<double> trkMVAvector() const;
  void settrkMVAvector (double atrkMVA); 
...
template <typename T>
std::vector<double> TTTrack<T>::trkMVAvector() const {
    return theTrkMVAvector_;
}
